...
# click button see all people results
driver.get(WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH, '//*[@id="main"]/div/div/div[1]/div/a'))).get_attribute('href'))
sleep(3)
